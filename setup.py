...
def read_module_contents():
    with open('treq_kerberos/__init__.py') as treq_kerberos_init:
        return treq_kerberos_init.read()
...
class BumpCommand(Command):
    ...
    def run(self):
        ...
        module_file = read_module_contents()
        with open('treq_kerberos/__init__.py', 'w') as fileh:
...
class ReleaseCommand(Command):
    ...
    def run(self):
        ...
        tarball = 'dist/%s-%s.tar.gz' % ('treq-kerberos', version)
...
setup(
    name='treq-kerberos',
    description="Kerberos auth for Twisted's treq",
    packages=['treq_kerberos'],
    author='Ken Dreyer',
    author_email='ktdreyer@ktdreyer.com',
    url='https://github.com/ktdreyer/treq-kerberos',
    version=metadata['version'],
    license='MIT',
    zip_safe=False,
